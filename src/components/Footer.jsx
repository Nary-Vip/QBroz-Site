        ...
        <div style={style} className="py-8 bg-gray-500" id="contactus">
            <div className="container flex flex-col items-center md:flex-row">
                <div className="flex flex-wrap items-center justify-center flex-1 gap-12 md:justify-start">
                    ...
                    <Link to="/"><h2 className="text-xl font-bold text-white font-pacifo"><span className="text-2xl font-bioRhyme">Q</span>broz Design and Publishing Services</h2></Link>
                </div>
                ...
                <ul className="flex mt-12 gap-7 md:mt-0">
                    ...
                    <li><a href="https://www.instagram.com" target="block"><IoLogoInstagram className="text-4xl text-pink-500"/></a></li>
                    ...
                    <li><a href="https://api.whatsapp.com/send?phone=7200893834" target="block"><FaWhatsappSquare className="text-4xl text-green-500"/></a></li>
