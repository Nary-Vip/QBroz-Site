...
import firstPic from "../Images/services2.png";
        ...
        <section className="relative">
            <div className="container flex flex-col-reverse items-center gap-12 lg:flex-row mt-14 lg:mt-28">
                ...
                <div className="flex flex-col items-center flex-1 lg:items-start">
                    <h2 className="mb-10 text-3xl text-center text-black md:text-4 lg:text-5xl lg:text-left">
                        Qbroz
                    </h2>
                ...
                <div className="z-10 flex justify-center flex-1 mb-10 md:mb-16 lg:mb-0">
                    <img className="pt-5 rounded-md h-5/6 q-5/6 sm:w-3/4 sm:h-3/4 md:w-5/6 md:h-5/6" src={firstPic} alt="Cover PIC"/>
                </div>
            </div>
            {/* Image design */}
            <div className="absolute right-0 hidden w-2/4 overflow-hidden rounded-l-full bg-neon-purple top-60 h-80 md:block lg:right-0">
            </div>
        </section>
        <Services/>
        </>
